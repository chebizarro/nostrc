...
| 16b | Samba server installed-client acceptance | PENDING: end-to-end file-serving demo against a real Windows/Explorer + GNOME Files client on the lab | Real client mounts, reads, writes, respects quotas, ACLs; retention across restart; passdb config drift-detector green | #16a ✅, #18 ✅ | XL |
