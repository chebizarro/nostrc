...
gchar *
g_nostr_store_get_note_by_id(GNostrStore *self, const gchar *id_hex, GError **error)
{
    GNostrStoreInterface *iface;
...
gchar *
g_nostr_store_get_note_by_key(GNostrStore *self, guint64 note_key, GError **error)
{
    GNostrStoreInterface *iface;
...
gchar *
g_nostr_store_get_profile_by_pubkey(GNostrStore *self, const gchar *pubkey_hex, GError **error)
{
    GNostrStoreInterface *iface;
...
GPtrArray *
g_nostr_store_text_search(GNostrStore *self, const gchar *query, gint limit, GError **error)
{
    GNostrStoreInterface *iface;
...
GPtrArray *
g_nostr_store_search_profile(GNostrStore *self, const gchar *query, gint limit, GError **error)
{
    GNostrStoreInterface *iface;
...
guint64
g_nostr_store_subscribe(GNostrStore *self, const gchar *filter_json)
{
    GNostrStoreInterface *iface;

    g_return_val_if_fail(G_NOSTR_IS_STORE(self), 0);
...
void
g_nostr_store_unsubscribe(GNostrStore *self, guint64 subid)
{
    GNostrStoreInterface *iface;

    g_return_if_fail(G_NOSTR_IS_STORE(self));
...
gint
g_nostr_store_poll_notes(GNostrStore *self, guint64 subid, guint64 *note_keys, gint capacity)
{
    GNostrStoreInterface *iface;
...
gboolean
g_nostr_store_get_note_counts(GNostrStore *self, const gchar *id_hex, GNostrNoteCounts *out)
{
    GNostrStoreInterface *iface;
...
gboolean
g_nostr_store_write_note_counts(GNostrStore *self, const gchar *id_hex, const GNostrNoteCounts *counts)
{
    GNostrStoreInterface *iface;
...
GHashTable *
g_nostr_store_count_reactions_batch(GNostrStore *self, const gchar * const *event_ids, guint n_ids)
{
    GNostrStoreInterface *iface;
...
GHashTable *
g_nostr_store_get_zap_stats_batch(GNostrStore *self, const gchar * const *event_ids, guint n_ids)
{
    GNostrStoreInterface *iface;
