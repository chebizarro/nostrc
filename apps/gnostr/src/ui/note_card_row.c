...
static void gnostr_note_card_row_dispose(GObject *obj) {
  ...
  /* Do NOT call any label modification functions (gtk_label_set_text, gtk_label_set_attributes, etc.)
   * during dispose - this triggers Pango layout recalculation which crashes when the widget's
   * internal state is being torn down. Let GTK handle label cleanup automatically. */
